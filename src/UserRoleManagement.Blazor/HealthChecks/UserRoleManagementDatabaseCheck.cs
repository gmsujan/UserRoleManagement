...
public class UserRoleManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public UserRoleManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
