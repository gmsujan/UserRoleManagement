...
{
    [DbContext(typeof(UserRoleManagementDbContext))]
    [Migration("20260713083155_Added_Access_Entities")]
    partial class Added_Access_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserRoleManagement.Access.AppPermission", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppAppPermissions", (string)null);
                });

            modelBuilder.Entity("UserRoleManagement.Access.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppAppRoles", (string)null);
                });

            modelBuilder.Entity("UserRoleManagement.Access.AppRolePermission", b =>
                {
                    ...
                    b.ToTable("AppAppRolePermissions", (string)null);
                });

            modelBuilder.Entity("UserRoleManagement.Access.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserRoleManagement.Access.AppUserRole", b =>
                {
                    ...
                    b.ToTable("AppAppUserRoles", (string)null);
                });

            modelBuilder.Entity("UserRoleManagement.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserRoleManagement.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserRoleManagement.Access.AppRolePermission", b =>
                {
                    b.HasOne("UserRoleManagement.Access.AppPermission", "Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserRoleManagement.Access.AppRole", "Role")
            ...
            modelBuilder.Entity("UserRoleManagement.Access.AppUserRole", b =>
                {
                    ...
                    b.HasOne("UserRoleManagement.Access.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("UserRoleManagement.Books.Book", b =>
                {
                    b.HasOne("UserRoleManagement.Authors.Author", null)
                        .WithMany()
