...
public class UserRoleManagementDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        UserRoleManagementGlobalFeatureConfigurator.Configure();
        UserRoleManagementModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<UserRoleManagementDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<UserRoleManagementResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/UserRoleManagement");

            options.DefaultResourceType = typeof(UserRoleManagementResource);
        ...
        {
            options.MapCodeNamespace("UserRoleManagement", typeof(UserRoleManagementResource));
        });
    }
}
